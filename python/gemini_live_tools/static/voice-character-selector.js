(function (global) {
    ...
    const CHARACTER_GROUPS = {
        ...
        skeptic: 'Core',
        professor: 'Academic',
        ivory_tower: 'Academic',
        symbolic_mind: 'Academic',
        rigor_mind: 'Academic',
        curious: 'Academic',
        down_under: 'Accents',
        tundra_terse: 'Accents',
        bosphorus: 'Accents',
        duck: 'Character',
        ...
        kids_tv: 'Character',
        heartland: 'Character',
        cafe_philosopher: 'Academic',
        compression_oracle: 'Academic',
        swamp_sage: 'Fiction',
        daisy_bell: 'Fiction',
        valley_voice: 'Fiction',
        sailor: 'Fiction',
        cowboy: 'Fiction',
        code_monkey: 'Fiction',
        speedrun: 'Speed',
    ...
    const CHARACTER_OPTIONS = [
        ...
        { id: 'particle_poet', label: 'Particle Poet', defaultVoice: 'Puck' },
        ...
        { id: 'ivory_tower', label: 'Ivory Tower', defaultVoice: 'Rasalgethi' },
        { id: 'down_under', label: 'Down Under', defaultVoice: 'Achird' },
        { id: 'tundra_terse', label: 'Tundra Terse', defaultVoice: 'Alnilam' },
        { id: 'bosphorus', label: 'Bosphorus', defaultVoice: 'Erinome' },
        ...
        { id: 'valley_voice', label: 'Valley Voice', defaultVoice: 'Puck' },
        ...
        { id: 'cape_noir', label: 'Cape Noir', defaultVoice: 'Algenib' },
        { id: 'swamp_sage', label: 'Swamp Sage', defaultVoice: 'Iapetus' },
        { id: 'daisy_bell', label: 'Daisy Bell', defaultVoice: 'Charon' },
        ...
        { id: 'symbolic_mind', label: 'Symbolic Mind', defaultVoice: 'Iapetus' },
        { id: 'rigor_mind', label: 'Rigor Mind', defaultVoice: 'Rasalgethi' },
        { id: 'welsh_poet', label: 'Welsh Poet', defaultVoice: 'Gacrux' },
