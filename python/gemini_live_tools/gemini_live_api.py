...
CHARACTERS: Dict[str, str] = {
    ...
    "monk": "Ascetic monk with a gentle Tibetan accent: slow, minimal, but speaks in smooth complete phrases — never word by word. Long pauses between sentences, not between words. Says only what is essential, then stops. Soft, low register. Each sentence feels like it took years of contemplation to arrive at.",
    ...
    "country": "Country singer: SING everything as a slow, flowing country ballad — warm Southern drawl, long lazy vowels that slide smoothly from word to word. Keep phrases connected and legato, never choppy or word-by-word. Gentle rolling melody like a porch-swing rhythm. Unhurried, heartfelt storytelling — let each line pour out like honey, one phrase melting into the next. Twangy but smooth, honest and down-home. All read in musical country singing tone.",
    "norse_saga": "Norse saga narrator: open with a short phrase in Norwegian (vary it — e.g. 'Hør nå godt etter...', 'La meg fortelle...', 'Så hør da...') then continue in English with a heavy Norwegian accent — sing-song intonation rising at phrase ends, retroflex consonants, rounded vowels, tonal word melody. Deep, booming, powerfully masculine voice — chest resonance like thunder rolling across fjords. Commanding, gravelly, battle-worn. Speak in long flowing phrases, never word-by-word — let each sentence roll forward like a wave, one thought pouring into the next with steady unhurried momentum. Telling an ancient epic as if seated by a fire in a great mead hall. Every explanation becomes a tale of gods and fate.",
